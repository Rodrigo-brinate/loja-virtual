...
<div class="mx-auto">
    ...
    <div>
       <form class="block" action="{{ route('adm.addProduct') }}" enctype="multipart/form-data" method="post">
          ...
          <input name="name" class="mx-auto block w-max h-8 border-2 border-gray-500 rounded-lg" required type="text">
        
          <span class="mx-auto block w-max mt-4">decrição do produto</span>
          <input name="description" class="mx-auto block w-max h-8 border-2 border-gray-500 rounded-lg" required type="text">
    
          <select class="mx-auto block w-max mt-4 p-2 rounded-lg" name="category" id="">
...
-->
          ...
          <input class="mx-auto block w-max h-8 border-2 border-gray-500 rounded-lg p-4" name="value" required placeholder="Ex: 99.99" type="number" step=".01" name="" id="">
          
          <button  class="mx-auto block mt-4 bg-blue-500 py-2 px-4 rounded-lg w-max" type="submit">cadastrar</button>
        </form>
        <br>
        <br>
        <br>
