...
<table class="table table-striped table-hover mx-2" >
    <thead>
      ...
      <tbody>
        ...
        <tr class="">
          <td style="" class="h-5">{{$item->category_name}}</td>
          <td class="h-5">
            <a class=" no-underline  bg-yellow-400 p-2 rounded-lg text-black " href="/edit/category/{{$item->id}}">editar</a>
          </td>
          <td class="h-5">
            <a class="no-underline  bg-red-500 p-2 rounded-lg text-black " href="/delete/category/{{$item->id}}">excluir</a>
          </td>
        </tr> 
        @endforeach
       </tbody>
