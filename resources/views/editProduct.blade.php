...
<table class="table table-striped table-hover" >
    <thead>
      ...
      <tbody>
        ...
        <tr>
            @csrf
          <th scope="row"> <input type="text" name="product_name" value="{{$product->product_name}}"></th>
          <td><input type="text" name="product_description" value="{{$product->product_description}}"></td>
